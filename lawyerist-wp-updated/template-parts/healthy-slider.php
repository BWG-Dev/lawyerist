...
<div class="main healthy_firm_slider"><!-- start healthy_firm_slider -->
    <div class="col-1">
        <div id="healthy-slider" class="slider-nav" dir="rtl">
            <div class="card healthy">
                ...
                <img class="fixed-btm-img" src="/wp-content/uploads/2022/01/healthy-page-cutouts-strategy.png"/>
            </div>
            <div class="card healthy">
                <div class="container">
                    <div class="icon-with-title">
                ...
                <img class="fixed-btm-img" src="/wp-content/uploads/2022/01/healthy-page-cutouts-team.png"/>
            </div>
            <div class="card healthy">
                <div class="container">
                    <div class="icon-with-title">
                ...
                <img class="fixed-btm-img" src="/wp-content/uploads/2022/02/healthy-page-cutouts-clients-1.png"/>
            </div>
            <div class="card healthy">
                <div class="container">
                    <div class="icon-with-title">
                ...
                <img class="fixed-btm-img" src="/wp-content/uploads/2022/01/healthy-page-cutouts-systems.png"/>
            </div>
            <div class="card healthy">
                <div class="container">
                    <div class="icon-with-title">
                ...
                <img class="fixed-btm-img" src="/wp-content/uploads/2022/01/healthy-page-cutouts-profits.png"/>
            </div>
            <div class="card healthy">
                <div class="container">
                    <div class="icon-with-title">
                ...
                <img class="fixed-btm-img" src="/wp-content/uploads/2022/01/healthy-page-cutouts-profits-1.png"/>
            </div>
        </div>
    </div>
    <div class="col-2">
