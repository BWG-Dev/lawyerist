...
<?php if (have_rows('step_three')): ?>
    <?php while (have_rows('step_three')): the_row();
        ...
        $member_one_avatar = get_sub_field('member_one_avatar');
        $member_one_name = get_sub_field('member_one_name');
        $member_one_label = get_sub_field('member_one_label');
        $member_one_link = get_sub_field('member_one_link');

        $member_two_avatar = get_sub_field('member_two_avatar');
        $member_two_name = get_sub_field('member_two_name');
        $member_two_label = get_sub_field('member_two_label');
        $member_two_link = get_sub_field('member_two_link');

        $member_three_avatar = get_sub_field('member_three_avatar');
        $member_three_name = get_sub_field('member_three_name');
        $member_three_label = get_sub_field('member_three_label');
        $member_three_link = get_sub_field('member_three_link');

        $member_four_avatar = get_sub_field('member_four_avatar');
        $member_four_name = get_sub_field('member_four_name');
        $member_four_label = get_sub_field('member_four_label');
        $member_four_link = get_sub_field('member_four_link');

        $member_five_avatar = get_sub_field('member_five_avatar');
        $member_five_name = get_sub_field('member_five_name');
        $member_five_label = get_sub_field('member_five_label');
        $member_five_link = get_sub_field('member_five_link');

        $member_six_avatar = get_sub_field('member_six_avatar');
        $member_six_name = get_sub_field('member_six_name');
        $member_six_label = get_sub_field('member_six_label');
        $member_six_link = get_sub_field('member_six_link');
        ...
        <section class="start-content" id="<?php if( !empty(  $anchor ) ): ?><?php echo $anchor; ?><?php endif; ?>">
            ...
            <?php if ( have_rows( 'members' ) ): ?>
                ...
                <?php while ( have_rows( 'members' ) ): the_row();
                    ...
                    <div class='column'>
                        <a href="<?php echo $link; ?>" class='one-column link' title="Meet <?php echo $name; ?>">
                            <div class="avatar member-one" style="background:url('<?php if( !empty( $image['url'] ) ): echo esc_url( $image['url'] ); endif; ?>');background-position:center;background-size:cover;background-repeat:no-repeat;"></div>
                            <span class="link-symbol"><?php echo $name; ?></span>
                            <p><?php echo $label; ?></p>
                        </a>
                    </div>
                <?php endwhile; ?>
            ...
            <div>
                <div class="full-width-review-slider position-r">
                    <div class="container">
                        <div class="review-inner-slider coin-03x">
                        <div>
